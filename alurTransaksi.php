...
<section id="main" class="container">
	...
	<div class="box">
		...
		<p>		Pengerjaan akta ini akan menghasilkan minuta akta yang akan diperiksa secara manual oleh pembuat akta bersama notaris.Jika akta telah sesuai maka akan diterukan kepada <b>notaris</b> untuk dilakukan akad bersama penghadap. Setelah akad selesai dilaksanakan, maka notaris akan menginput isi akta tersebut ke dalam website Administrasi Hukum Umum dan output berupa (softcopy) SK dan Salinan Akta akan diserahkan kepada pembuat akta  untuk di cetak sementara minuta akta diarsip.</p>
